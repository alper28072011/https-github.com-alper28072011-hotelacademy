  ...
  return (
    <div className="flex gap-4">
        ...
        <div className="flex-1 pt-1 min-w-0">
            ...
            {/* Social Counts */}
            <div className="flex gap-4 text-[11px] px-1 mb-2">
                <div><span className="font-bold text-[#333]">{followersCount}</span> <span className="text-[#999]">Takipçi</span></div>
                <div><span className="font-bold text-[#333]">{followingCount}</span> <span className="text-[#999]">Takip</span></div>
                <div><span className="font-bold text-[#333]">{postCount}</span> <span className="text-[#999]">Gönderi</span></div>
            </div>
