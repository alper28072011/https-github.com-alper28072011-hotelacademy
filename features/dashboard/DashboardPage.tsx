    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white border border-[#bdc7d8] p-3">
          ...
          <div className="flex gap-2">
              <input 
                  ...
                  className="flex-1 border-none outline-none text-[13px] text-[#333] placeholder-gray-400 h-8"
              />
          </div>
          <div className="flex justify-end mt-2">
              <button className="bg-[#3b5998] border border-[#29447e] text-white px-3 py-1 text-[11px] font-bold hover:bg-[#2d4373]">
                  Paylaş
              </button>
          </div>
      </div>
              ...
              <div className="divide-y divide-[#e9e9e9]">
                  {duties.slice(0,3).map(course => (
                      ...
                      >
                          ...
                          <button className="bg-[#f7f7f7] border border-[#ccc] text-[9px] font-bold px-2 py-0.5 hover:bg-[#e9e9e9]">Başla</button>
                      </div>
                  ))}
              </div>
          </div>
      ...
      <div>
          {feedItems.length === 0 && !loading ? (
              <div className="bg-white border border-[#bdc7d8] p-10 text-center text-gray-400 text-xs">
