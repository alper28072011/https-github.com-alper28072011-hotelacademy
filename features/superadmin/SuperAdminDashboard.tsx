            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4">
                  ...
                  <div 
                    ...
                    className="bg-gray-900 p-6 rounded-3xl border border-gray-800 relative overflow-hidden group cursor-pointer hover:border-blue-500/50 transition-colors"
                  >
                  ...
                  <div 
                    ...
                    className="bg-gray-900 p-6 rounded-3xl border border-gray-800 relative overflow-hidden group cursor-pointer hover:border-purple-500/50 transition-colors"
                  >
                      ...
                      <h3 className="text-3xl font-bold mb-1">Yönet</h3>
                      <p className="text-sm text-gray-500">Kullanıcı Veritabanı</p>
                  </div>
