...
export const OrganizationSettings: React.FC = () => {
  const { currentOrganization, switchToOrganizationAction } = useOrganizationStore();
  ...
  const handleSave = async () => {
      ...
      await switchToOrganizationAction(currentOrganization.id);
  ...
  const handleChannelUpdate = async (channelId: string, updates: Partial<Channel>) => {
      ...
      await switchToOrganizationAction(currentOrganization.id); // Refresh
  };
  ...
  const handleTransfer = async () => {
      ...
      if (success) {
          ...
          await switchToOrganizationAction(currentOrganization.id); // Refresh roles
          navigate('/admin');
      } else {
